...
// $(document).ready(function(){
//     $("#nav-icon4").click(function(){
//         $(".jsLessonListBody").toggle();
//     });
// });
$('#nav-icon4').click(function() {
		if ($(this).hasClass('open'))
		 {
		$(this).closest('.col-lg-4').removeClass('col-lg-4').addClass('col-lg-1').find('.jsH2').addClass('close')
        .closest('.row').find('.col-lg-8').removeClass('col-lg-8').addClass('col-lg-11')
    }
       else  {
			 $(this).closest('.col-lg-1').removeClass('col-lg-1').addClass('col-lg-4').find('.jsH2').removeClass('close')
        .closest('.row').find('.col-lg-11').removeClass('col-lg-11').addClass('col-lg-8')
    }
 });
///////////////////

$(document).ready(function() {
	$('.jsCheckall').change(function() {
		$('.jsOption:checkbox').prop('checked', $(this).prop('checked'));
	});
});
...
$('.dropdown__ground').removeClass('dropdown__ground');
